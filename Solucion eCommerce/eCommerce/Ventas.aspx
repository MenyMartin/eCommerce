...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center gap-3">
            ...
            <%--<asp:Button ID="btnListaUsuarios" runat="server" Text="Lista de usuarios" CssClass="btn btn-success" OnClick="btnListaUsuarios_Click" />
            <asp:Button ID="btnListaVentas" runat="server" Text="Lista de ventas" CssClass="btn btn-success" OnClick="btnListaVentas_Click" />
            <asp:Button ID="btnEstadisticas" runat="server" Text="Estadisticas" CssClass="btn btn-success" OnClick="btnEstadisticas_Click" />--%>

            <%--<asp:Button ID="btnSeguimientoPedidos" runat="server" Text="Seguimiento de pedidos" CssClass="btn btn-success" OnClick="btnSeguimientoPedidos_Click" />--%>
