...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateColumns="false" CssClass="table table-striped mt-4" OnRowCommand="gvUsuarios_RowCommand">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Estadísticas">
                <ItemTemplate>
                    <asp:Button ID="btnEstadisticas" runat="server" Text="Ver" CssClass="btn btn-primary btn-sm"
                        CommandName="VerEstadisticas" CommandArgument='<%# Eval("DNI") %>' />
                </ItemTemplate>
            </asp:TemplateField>
